// Patch from CLIProxyAPI PR #4079 (custom_tool_call response translation)
// Replace: internal/translator/codex/openai/chat-completions/codex_openai_response.go
